	...
	<body>
		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div class="page-content">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php/maintenance/cetak" target="_blank" role="button" class="btn btn-yellow"> Cetak PDF </a>
					...
					<div class="row-fluid">
									...
									<thead>
                                                                                ...
                                                                                <th class="center">Kode Maintenance</th>
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
                                                                    <?php 
                                                                        $no=1;
                                                                        foreach ($data_maintenance as $row) {    
                                                                    ?>
                                                                    <tr class="odd">
                                                                                        <td class="center"><?php echo $no ?></td>
											<td class="center"><?php echo $row->no_maintenance ?></td>
											<td class="center"><?php echo $row->aset_masuk ?></td>
                                                                                        <td class="center"><?php echo $row->tanggal_mulai ?></td>
                                                                                        <td class="center"><?php echo $row->tanggal_selesai?></td>
                                                                                       <td class="center"><?php echo 'Rp '.number_format($row->biaya, 2, ",", ".") ?></td>
											<td class="td-actions ">
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="green btn_edit" href="#" 
                                                                                                           data-no_maintenance="<?php echo $row->no_maintenance;?>"
                                                                                                           data-aset_masuk="<?php echo $row->aset_masuk;?>"
                                                                                                           data-tanggal_mulai="<?php echo $row->tanggal_mulai;?>"
                                                                                                           data-tanggal_selesai="<?php echo $row->tanggal_selesai;?>"
		...
		<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-small btn-inverse">
			<i class="icon-double-angle-up icon-only bigger-110"></i>
                ...
                <form method="post" id="modal_form1" name="modal_form1" action="<?php echo base_url();?>index.php/maintenance/simpan/" enctype="multipart/form-data">
                            ...
                            <div class="row-fluid">
                                    <div class="span12">
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span4" name="no_maintenance" id="no_maintenance" placeholder="Kode Maintenance"
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span3 align-right biaya" name="biaya" id="biaya"/>
                                                    </div>
                                            </div>
                                    </div>
                            </div>
                ...
                <form method="post" id="modal_form2" name="modal_form2" action="<?php echo base_url();?>index.php/maintenance/ubah/" enctype="multipart/form-data">
                            ...
                            <div class="row-fluid">
                                    <div class="span12">
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label">Kode Maintenance</label>
                                                    <div class="controls">
                                                        <input type="text" class="span4 no_maintenance" name="no_maintenance" id="no_maintenance" placeholder="Kode Pinjam"
                                                            readonly="true"/>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label">Tanggal Mulai</label>
                                                    <div class="controls">
                                                        <input type="text" class="span2 tanggal_mulai" name="tanggal_mulai" id="tanggal_mulai"/>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    <label class="control-label">Tanggal Selesai</label>
                                                    <div class="controls">
                                                        <input type="text" class="span2 tanggal_selesai" name="tanggal_selesai" id="tanggal_selesai"/>
                                                    </div>
                                            </div>
                                           <div class="control-group">
                                                    <label class="control-label">Biaya</label>
                                                    <div class="controls">
                                                        <input type="text" class="span3 align-right biaya biaya2" name="biaya" id="biaya"/>
                                                    </div>
                                            </div>
                                    </div>
                            </div>
               ...
               $(document).ready(function(){
                    ...
                    var value1 =$('.biaya').maskMoney('unmasked')[0];
                    $('.biaya').val(value1);
                    });
                    
                    $("#modal_form2").submit(function(){
                    var value1 =$('.biaya2').maskMoney('unmasked')[0];
                    $('.biaya2').val(value1);
                    });
                });
                </script>
                ...
                $(document).ready(function(){
                    ...
                    const no_maintenance = $(this).data('no_maintenance');
                    ...
                    const tanggal_selesai= $(this).data('tanggal_selesai');
                        bootbox.confirm(aset_masuk+" akan dihapus?", function(result) {
                            if(result) {
                                window.location.href ="<?= base_url();?>index.php/maintenance/hapus/"+no_maintenance;
                            }				
                    });
                    });
                });
                ...
                $(document).ready(function(){
                        ...
                        $('.no_maintenance').val(no_maintenance);
                        ...
                        $('.biaya').val(biaya);
                        $('.biaya2').maskMoney({prefix:'Rp ',
                                              allowNegative: true,
                                              thousands:'.', decimal:',',
                                              allowZero: true,
                                              affixesStay: true});
                        $('.biaya2').each(function(){
                            $(this).maskMoney('mask', $(this).val());
                        });
