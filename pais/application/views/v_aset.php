	...
	<body>
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Kelola Data Aset</li>
					</ul><!--.breadcrumb-->
				...
				<div class="page-content">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php/aset/cetak" target="_blank" role="button" class="btn btn-yellow"> Cetak PDF </a>
					...
					<div class="row-fluid">
								...
								<tbody role="alert" aria-live="polite" aria-relevant="all">
											...
											<td class="center"><?php echo $row->no_aset ?></td>
											<td class="center"><?php echo $row->aset_masuk ?></td>
											<td class="center"><?php echo $row->kondisi_aset ?></td>
											...
											<td class="td-actions ">
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="green btn_edit" href="#" 
                                                                                                           data-no_aset="<?php echo $row->no_aset;?>"
                                                                                                           data-aset_masuk="<?php echo $row->aset_masuk;?>"
                                                                                                           data-kondisi_aset="<?php echo $row->kondisi_aset;?>"
		...
		<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-small btn-inverse">
			<i class="icon-double-angle-up icon-only bigger-110"></i>
                ...
                <form method="post" id="modal_form1" name="modal_form1" action="<?php echo base_url();?>index.php/aset/simpan/" enctype="multipart/form-data">
                            ...
                            <div class="row-fluid">
                                    <div class="span12">
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span4" name="no_aset" id="no_aset" placeholder="Kode Aset"
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="kondisi_aset" id="kondisi_aset" class="span9">
                                                            <option value="-">-</option> />
                                                                <?php
                                                                    foreach ($data_kondisi_aset->result() as $data){
                                                                ?>
                                                                    <option value="<?php echo $data->nama_kondisi_aset; ?>"><?php echo $data->nama_kondisi_aset; ?>										
                                                                    </option>
                                                                <?php
                                                                    }
                                                                ?>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span12" name="stok" id="keterangan" placeholder="stok"/>
                                                    </div>
                                            </div>
                ...
                <form method="post" id="modal_form2" name="modal_form2" action="<?php echo base_url();?>index.php/aset/ubah/" enctype="multipart/form-data">
                            ...
                            <div class="row-fluid">
                                    <div class="span12">
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label">Kode Aset</label>
                                                    <div class="controls">
                                                        <input type="text" class="span4 no_aset" name="no_aset" id="no_aset" placeholder="Kode Aset"
                                                            readonly="true"/>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label">Kondisi Aset</label>
                                                    <div class="controls">
                                                        <select name="kondisi_aset" id="kondisi_aset" class="span9 kondisi_aset">
                                                            <option value="-">-</option> />
                                                                <?php
                                                                    foreach ($data_kondisi_aset->result() as $data){
                                                                ?>
                                            ...
                                            <div class="control-group">
                                                        <label class="control-label">stok</label>
                                                        <div class="controls">
                                                            <input type="text" class="span12 stok" name="stok" id="stok"/>
                                                        </div>
                                            </div>
                ...
                $(document).ready(function(){
                        ...
                        const no_aset = $(this).data('no_aset');
                        const aset_masuk = $(this).data('aset_masuk');
                        const kondisi_aset = $(this).data('kondisi_aset');
